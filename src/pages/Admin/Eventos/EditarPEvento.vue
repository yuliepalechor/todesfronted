      ...
      <md-card-content>
        <div class="md-layout">
          ...
          <div class="md-layout-item md-small-size-100 md-size-50">
            <md-field>
              <!-- <label>Estado</label> -->
              <select v-model="form.estado" class="form-control selectpicker" data-style="btn btn-link"
          ...
          <div class="md-layout-item md-small-size-100 md-size-50">
            <md-field>
              <label>Tipo</label>
              <select v-model="form.tipo" class="form-control selectpicker" data-style="btn btn-link"
                id="exampleFormControlSelect2">
                <option>Seleccione...</option>
