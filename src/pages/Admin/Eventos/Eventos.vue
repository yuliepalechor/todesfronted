            ...
            <div>
              ...
              >
                <md-table-row slot="md-table-row" slot-scope="{ item }">
                  ...
                  <md-table-cell md-label="Fecha y Hora">{{
                    item.fecha_y_Hora
                  }}</md-table-cell>
                  <md-table-cell md-label="Lugar">{{
                    item.lugar
                  }}</md-table-cell>
                  <md-table-cell md-label="Estado">{{
                    item.estado
                  }}</md-table-cell>
                  <md-table-cell md-label="Url Externa">{{
                    item.urlExterna
                  }}</md-table-cell>
                  <md-table-cell md-label="Responsable">{{
                    item.responsable
                  }}</md-table-cell>
                  <md-table-cell md-label="Fecha Caducidad">{{
                  ...
                  <md-table-cell md-label="Editar">
                    <md-button
                      @click="editar(editarpublicacion(item.id))"
